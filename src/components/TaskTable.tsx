                ...
                <table className="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
                    <thead className="ltr:text-left rtl:text-right">
                        <tr>
                            ...
                            <th className="whitespace-nowrap px-4 py-2 font-medium text-gray-900 text-left">Due Date</th>
                            <th className="whitespace-nowrap px-4 py-2 font-medium text-gray-900 text-left">Assignee</th>
                            <th className="whitespace-nowrap px-4 py-2 font-medium text-gray-900 text-left">Priority</th>
